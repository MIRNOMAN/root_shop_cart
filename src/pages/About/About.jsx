...
const About = () => {
  ...
  <section className="bg-gray-100 lg:px-16 px-4 py-6">
         ...
         <div className="lg:flex mt-20 relative">
              <div className="w-1/3">
                 <img className="h-[450px] top-20 object-cover left-16 w-[500px] border-8 rounded-lg border-white-100 absolute" src={coverimg} alt="" />
              </div>

              <div className="w-2/3 h-[650px] bg-black py-28 pr-12 pl-[20%]">
                  <h1 className=" text-stone-400 font-medium">DISCOVER MISSION AND VALUES</h1>

                  <h1 className="text-white text-3xl my-4 font-normal">OUR COMPANY</h1>
                  ...
                  <div className="text-white my-6">
                    <h2 className="text-lg font-medium">01 Safety First, Not Sales:</h2>
                    <p className=" text-sm text-stone-400 pt-2">experienced discounts, new home and loyalty discounts. that's just the beginning.</p>
                  </div>
                  <div className="text-white my-6">
                    <h2 className="text-lg font-medium">02 Protecting Your Budget:</h2>
                    <p className=" text-sm text-stone-400 pt-2">experienced discounts, new home and loyalty discounts. that's just the beginning.</p>
                  </div>
                  <div className="text-white">
                    <h2 className="text-lg font-medium">03 High Quality Insurance:</h2>
         ...
         <div className="flex justify-center items-center gap-7 mb-20 mt-10">
