        ...
        <>
            <button className='relative z-20 mr-3 ml-5' onClick={openModal}>
                ...
                <div className='absolute  -top-4 -right-2'>
                    <span className='bg-primary-green rounded-full text-base p-[2px] text-white'>10</span>
                </div>
            </button>
            ...
            <div className={`cartmodel p-12 text-primary ${isCloseing ? "closing" : ""}`}>
                <div className="flex justify-between gap-5">
                   ...
                   Wishlist  
                    <span className="w-7 h-7 text-[11px] font-normal rounded-full text-white grid place-content-center bg-primary">0</span>
                   </button>
                </div>
